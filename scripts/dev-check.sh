...
bun scripts/tasks_v2_snapshot_stability_selftest.ts >/dev/null
...
bun scripts/autowork_local_lifecycle_swarm_selftest.ts >/dev/null
bun scripts/autowork_local_lifecycle_restore_selftest.ts >/dev/null
