...
const NPM_DEPRECATION_MESSAGE = 'SeaTurtle has switched from npm to the native installer. Run `ct install` or see https://github.com/bretlindquist/seaturtle-cli#readme for more options.';
