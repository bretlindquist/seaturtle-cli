...
const DEFAULT_PREFIX = `You are CT, a terminal-based coding agent.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are CT, a terminal-based coding agent, running within the Claude Agent SDK.`
