...
const APP_NAME = 'SeaTurtle CLI URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'SeaTurtle CLI URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>SeaTurtle CLI Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for SeaTurtle CLI
