import { SWORDS_OF_CHAOS_RARITY_UNLOCK } from '../../game/rewards.js'
import type {
  SwordsOfChaosOutcome,
  SwordsOfChaosRoute,
} from '../types/outcomes.js'

export const SWORDS_OF_CHAOS_OUTCOMES: Record<
  SwordsOfChaosRoute,
  SwordsOfChaosOutcome
> = {
  'draw-steel:cut-the-sign-chain': {
    ...
    ending:
      'Steel rings against old neon. The sign chain snaps, the alley goes dark, and the figure under the lamp leaves behind a trench-coat relic blade.\n\nThe relic is now in the Half-Shell Archives.',
  },
  ...
  'bow-slightly:meet-the-gaze': {
    ...
    gameResult: 'win',
    legendEvent:
      'Met the watcher beneath the broken lamp gaze-for-gaze in Swords of Chaos and earned the title Witness of the Broken Lamp.',
    ending:
      'You raise your head. The watcher does not flinch. Somewhere above, the broken lamp steadies.\n\nThe figure under the lamp names you Witness of the Broken Lamp.\n\nThe title is now in the Half-Shell Archives.',
  },
  ...
  'talk-like-you-belong:laugh-like-you-mean-it': {
    ...
    ending:
      'Against all sensible advice, you laugh. The figure answers with the smallest possible grin.\n\nSomething bright skids across the pavement: a static-lacquer arcade chip.\n\nThe relic is now in the Half-Shell Archives.',
  },
  'talk-like-you-belong:double-down': {
    ...
    ending:
      'You keep talking like you own the place until the alley almost believes you.\n\nThe figure under the lamp leaves you with a truth: "Confidence becomes prophecy if you survive it."\n\nThe truth is now in the Half-Shell Archives.',
  },
}
