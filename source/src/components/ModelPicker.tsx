...
export function ModelPicker(t0) {
  ...
  const t16 = headerText ?? (shouldUseOpenAiCodexProvider() ? "Switch between the OpenAI/Codex models currently supported by this build. Applies to this session and future Claude Code sessions." : "Switch between the models currently supported by this build. Applies to this session and future Claude Code sessions. For other/previous model names, specify with --model.");
  let t17;
  if ($[42] !== t16) {
