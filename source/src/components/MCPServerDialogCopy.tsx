...
export function MCPServerDialogCopy() {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = <Text>MCP servers may execute code or access system resources. All tool calls require approval. Learn more in the{" "}<Link url={PRODUCT_DOCS_URL}>SeaTurtle docs</Link>.</Text>;
    $[0] = t0;
  } else {
    t0 = $[0];
  }
