...
const questionOptionSchema = lazySchema(() => z.object({
  ...
  description: z.string().optional().describe('Optional explanation of what this option means or what will happen if chosen. Useful for providing context about trade-offs or implications.'),
...
const questionSchema = lazySchema(() => z.object({
  ...
  header: z.string().optional().describe(`Optional short label displayed as a chip/tag (max ${ASK_USER_QUESTION_TOOL_CHIP_WIDTH} chars). Examples: "Auth method", "Library", "Approach".`),
...
function AskUserQuestionResultMessage(t0) {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = <Box flexDirection="row"><Text color={getModeColor("default")}>{BLACK_CIRCLE} </Text><Text>User answered the questions:</Text></Box>;
    $[0] = t1;
  } else {
    t1 = $[0];
  }
